...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
    ...
    const translations: Record<Language, Record<string, string>> = {
        bg: {
            ...
            createProjectTemplate: "Създай шаблон за проект",
            createTaskTemplate: "Създай шаблон за задача",
            templateName: "Име на шаблона",
            templateDescription: "Описание",
            templatePriority: "Приоритет",
            templateDuration: "Продължителност (дни)",
            templatePublic: "Публичен шаблон",
            templatePublicDesc: "Видим за всички потребители",
            templateTasks: "Задачи в шаблона",
            addTask: "Добави задача",
            taskTitle: "Заглавие на задачата",
            estHours: "Предвидени часове",
            templateAddSubtask: "Добави подзадача",
            addToTemplate: "Добави към шаблона",
            templateCancel: "Отказ",
            templateCreate: "Създай",
            category: "Категория",
            ...
            noProjectTemplates: "Няма намерени шаблони за проекти",
            noTaskTemplates: "Няма намерени шаблони за задачи",
            createFirstOne: "Създай първия",
            ...
            adminTabsOverview: "Преглед",
            adminTabsUsers: "Потребители",
            adminTabsStatuses: "Статуси",
            adminTabsPriorities: "Приоритети",
            adminTabsLogs: "Одитен Лог",
            adminStatsTotalProjects: "Общо проекти",
            adminStatsActiveText: "в процес",
            adminStatsActiveProjects: "Активни проекти",
            adminStatsTotalTasks: "Общо задачи",
            adminStatsCompletedText: "завършени задачи",
            adminStatsCompletionRate: "Процент на завършване",
            adminStatsTotalUsers: "Потребители",
            adminStatsRegisteredText: "Регистрирани в системата",
            // Status Management
            statuses: "Статуси",
            statusesDesc: "Управление на статуси за задачи и проекти.",
            addStatus: "Добави статус",
            startStatusName: "Име",
            color: "Цвят",
            editStatus: "Редактиране на статус",
            newStatus: "Нов статус",
            defineStatusParams: "Дефинирайте параметрите на статуса.",
            order: "Подредба",
            default: "По подразбиране",
            defaultStatusHelp: "Ако е избрано, този статус ще се избира автоматично за нови елементи.",
            ...
            errorInitializing: "Грешка при инициализация",
            statusUpdatedMsg: "Статусът е обновен успешно",
            statusCreated: "Статусът е създаден успешно",
            statusDeleted: "Статусът е изтрит",
            deleteStatusConfirm: "Сигурни ли сте, че искате да изтриете този статус?",
            cannotEditGlobalStatus: "Не можете да редактирате глобален статус.",
            cannotDeleteGlobalStatus: "Не можете да изтриете глобален статус.",

            // Priority Management
            priorities: "Приоритети",
            prioritiesDesc: "Управлявайте нивата на приоритизация за задачи и проекти.",
            addPriority: "Добави приоритет",
            editPriority: "Редактиране на приоритет",
            newPriority: "Нов приоритет",
            definePriorityParams: "Дефинирайте цветове и етикети за приоритет.",
            priorityCreated: "Приоритетът е създаден успешно",
            priorityUpdated: "Приоритетът е обновен успешно",
            priorityDeleted: "Приоритетът е изтрит",
            deletePriorityConfirm: "Сигурни ли сте, че искате да изтриете този приоритет?",
            noPriorities: "Няма намерени приоритети",
            noPrioritiesFor: "Няма дефинирани приоритети за",

            // Settings
            taskSettings: "Настройки на задачи",
            taskSettingsDesc: "Управление на статуси и приоритети за вашето работно място.",
            tabTasksSettings: "Задачи и Работен процес",
            global: "Глобален",
            team: "Екип",
            create: "Създай",
        ...
        en: {
            ...
            templateDuration: "Est. Duration (Days)",
            templatePublic: "Make Public",
            templatePublicDesc: "Visible to all users",
            templateTasks: "Template Tasks",
            addTask: "Add Task",
            taskTitle: "Task Title",
            estHours: "Est. Hours",
            templateAddSubtask: "Add Subtask",
            ...
            noProjectTemplates: "No project templates found",
            noTaskTemplates: "No task templates found",
            ...
            adminTabsUsers: "Users",
            adminTabsStatuses: "Statuses",
            adminTabsPriorities: "Priorities",
            adminTabsLogs: "Audit Log",
            adminStatsTotalProjects: "Total Projects",
            adminStatsActiveText: "in progress",
            adminStatsActiveProjects: "Active Projects",
            adminStatsTotalTasks: "Total Tasks",
            adminStatsCompletedText: "completed tasks",
            adminStatsCompletionRate: "Completion Rate",
            adminStatsTotalUsers: "Total Users",
            adminStatsRegisteredText: "Registered in system",
            // Status Management
            statuses: "Statuses",
            statusesDesc: "Manage statuses for tasks and projects.",
            addStatus: "Add Status",
            startStatusName: "Name",
            color: "Color",
            editStatus: "Edit Status",
            newStatus: "New Status",
            defineStatusParams: "Define status parameters.",
            order: "Order",
            default: "Default",
            defaultStatusHelp: "If selected, this status will be automatically selected for new items.",
            ...
            errorInitializing: "Error initializing defaults",
            statusUpdatedMsg: "Status updated successfully",
            statusCreated: "Status created successfully",
            statusDeleted: "Status deleted",
            deleteStatusConfirm: "Are you sure you want to delete this status?",
            cannotEditGlobalStatus: "Cannot edit global status.",
            cannotDeleteGlobalStatus: "Cannot delete global status.",

            // Priority Management
            priorities: "Priorities",
            prioritiesDesc: "Manage priority levels for tasks and projects.",
            addPriority: "Add Priority",
            editPriority: "Edit Priority",
            newPriority: "New Priority",
            definePriorityParams: "Define colors and labels for priority.",
            ...
            deletePriorityConfirm: "Are you sure you want to delete this priority?",
            noPriorities: "No priorities found",
            noPrioritiesFor: "No priorities defined for",

            // Settings
            taskSettings: "Task Settings",
            taskSettingsDesc: "Manage custom statuses and priorities for your workspace.",
            tabTasksSettings: "Tasks & Workflow",
            global: "Global",
            team: "Team",
            create: "Create",
